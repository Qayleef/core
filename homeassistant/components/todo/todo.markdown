...
Removes all to-do items (both completed and incomplete items) from a to-do list. A to-do list `target` is selected with a [Target Selector](/docs/blueprint/selectors/#target-selector).
